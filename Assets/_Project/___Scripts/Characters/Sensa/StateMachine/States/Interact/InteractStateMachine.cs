...
public class InteractStateMachine : BaseStateMachine<EnumInteract, InteractBaseState>
{
    ...
    public InteractStateMachine()
    {
        ...
        States = new Dictionary<EnumInteract, InteractBaseState>();
        _animationMap = new Dictionary<EnumInteract, string>();
    }
