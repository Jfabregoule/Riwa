...
public class RiwaLoadSceneSystem : LoadSceneSystem<RiwaLoadSceneSystem>
{
    ...
    private void Start()
    {
        EnqueueScenes(new[] { new SceneData("MainMenu"), new SceneData("HUD", 0, new Action[] { GameManager.Instance.SetBlackScreen,RiwaCinematicSystem.Instance.SetCanvasGroup,GameManager.Instance.SetNavbar, SaveSystem.Instance.LoadSettingsData }) }, false);
    }
